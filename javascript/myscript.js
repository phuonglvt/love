...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Nhịp đập của nhau :v " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Đừng nhấp chố này';
document.querySelector('.Description .modal-body').innerHTML = 'Trên kia đi bạn <i class="fas fa-heart"></i> ';
var author = document.querySelector('.author .me');author.style.opacity = "0.5";
author.innerHTML = "Bản quyền thuộc về<a href='https://www.facebook.com/thienvuong.12082000'>Lmint<a>";
